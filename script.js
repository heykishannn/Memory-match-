...
function getGridSize(level) {
    ...
    // which is 100px. Add row-gap.
    const estimatedCardHeightWithGap = 100 + 12; // 100px card + 12px row-gap
...
function startLevel(level) {
  ...
  state.cards.forEach((card,i)=>{
    ...
    cardEl.className = 'card'; // Removed 'cover' class as flip is applied directly
    cardEl.tabIndex = 0;
